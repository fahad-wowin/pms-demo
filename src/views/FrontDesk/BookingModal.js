...
const roomOptions = [
    { value: '102', label: '102 - First Floor' },
    { value: '103', label: '103 - First Floor' },
    { value: '104', label: '104 - First Floor' },
    { value: '205', label: '205 - Second Floor' },
    { value: '206', label: '206 - Second Floor' }
]
...
const BookingModal = ({ open, handleOpen, roomData }) => {
