...
const RoomStatus = ({ roomsStatusList, refreshList, loader }) => {
  ...
  const EditRoomStatusModal = ({ id }) => {
    ...
    const editHandleSubmit = () => {
      setEditDisplay(true)
      if (editStatus.trim() && editStatusDescription.trim() !== '') {
        roomStatusEdit()
        handleEditModal()
                    ...
                    <Row className='mb-1'>
                      ...
                      <Col md='8'>
                        <Input
                          ...
                          invalid={editDisplay && editStatus.trim() === ''}
                        />
                        {editDisplay === true && !editStatus.trim() ? <span className='error_msg_lbl'>Name is required </span> : <></>}
                      </Col>
                    </Row>
                    <Row>
                      <Col md='2 mt-md-50'>
                      ...
                      <Col md='8'>
                        <Input
                          ...
                          invalid={editDisplay && editStatusDescription.trim() === ''}
                        />
                        {editDisplay === true && !editStatusDescription.trim() ? <span className='error_msg_lbl'>Description is required </span> : <></>}
                      </Col>
                    </Row>
                  </Col>
                  </Row>
                ...
                <Row>
                  ...
                  <Col md='4'>
                    <Input
                      ...
                      invalid={display && Status.trim() === ''}
                    />
                    {display === true && !Status.trim() ? <span className='error_msg_lbl'>Name is required </span> : null}
                  </Col>
                  <Col md='2 text-md-end mt-md-50'>
                  ...
                  <Col md='4'>
                    <Input
                      ...
                      invalid={display && StatusDescription.trim() === ''}
                    />
                    {display === true && !StatusDescription.trim() ? <span className='error_msg_lbl'>Description is required </span> : null}
                  </Col>
                </Row>
              </Col>
